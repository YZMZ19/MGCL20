...
///If more than one are necessary to hold, CSisects should be used.
/// Curve と Surface の交点を表現する。
class MG_DLL_DECLR MGCSisect:public MGisect{
...
MGCSisect(
	...
	const MGCSRELATION rl= MGCSRELATION::MGCSREL_UNKNOWN	///<Curve and Surface relation
);
virtual ~MGCSisect()=default;
...
void distance(
	...
	double& t,///< difference of curve parameters.
	double& u,///< difference of u parameters.
	double& v///< difference of v parameters.
)const;
